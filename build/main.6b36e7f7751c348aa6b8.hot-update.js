...
function () {
  ...
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee2(req, res, next) {
    var source, change, control, controlObj, dataArr, body, result;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            console.log(control);
            dataArr = repeatData(source, change, controlObj.repeat || 1, controlObj.total || 1);
            body = dataArr.flatMap(function (source) {
              return [{
                index: {
                  _index: controlObj.index,
                  _type: "log",
                  _id: source.id
                }
              }, source];
            });
            fs__WEBPACK_IMPORTED_MODULE_9___default.a.writeFileSync('./data', JSON.stringify(body));
            _context2.prev = 9;
            _context2.next = 12;
            return client.bulk({
              refresh: true,
...
//# sourceMappingURL=main.6b36e7f7751c348aa6b8.hot-update.js.map