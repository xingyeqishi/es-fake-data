...
/* harmony import */ var _elastic_elasticsearch__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @elastic/elasticsearch */ "@elastic/elasticsearch");
/* harmony import */ var _elastic_elasticsearch__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_elastic_elasticsearch__WEBPACK_IMPORTED_MODULE_10__);
...
var client = new _elastic_elasticsearch__WEBPACK_IMPORTED_MODULE_10__["Client"]({
...
server.disable('x-powered-by').use(express__WEBPACK_IMPORTED_MODULE_6___default.a["static"]("/Users/xiji/workspace/fe-fake/public")).use(body_parser__WEBPACK_IMPORTED_MODULE_7___default.a.json()).get('/*', function (req, res) {
  var context = {};
  var markup = Object(react_dom_server__WEBPACK_IMPORTED_MODULE_9__["renderToString"])(react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_5__["StaticRouter"], {
    context: context,
    location: req.url,
    __source: {
        ...
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            change.forEach(function (item) {
              ...
              source[key] = faker__WEBPACK_IMPORTED_MODULE_8___default.a.internet[type]();
            });
            source.id = faker__WEBPACK_IMPORTED_MODULE_8___default.a.random.uuid();
            _context2.prev = 8;
            _context2.next = 11;
            return client.bulk({
              body: [{
...
//# sourceMappingURL=main.394193ee532d8fdd5ecb.hot-update.js.map